...
-- 資料表的限制式 `cart`
--
ALTER TABLE `cart` ADD CONSTRAINT `cart_ibfk_1` FOREIGN KEY (`userID`) REFERENCES `user` (`userID`),
ADD CONSTRAINT `cart_ibfk_2` FOREIGN KEY (`sparePartNum`) REFERENCES `spare` (`sparePartNum`);

--
-- 資料表的限制式 `order`
--
ALTER TABLE `order` ADD CONSTRAINT `order_ibfk_1` FOREIGN KEY (`salesManagerID`) REFERENCES `salemanager` (`salesManagerID`),
ADD CONSTRAINT `order_ibfk_2` FOREIGN KEY (`dealerID`) REFERENCES `dealer` (`dealerID`);

--
-- 資料表的限制式 `orderspare`
--
ALTER TABLE `orderspare` ADD CONSTRAINT `orderspare_ibfk_1` FOREIGN KEY (`sparePartNum`) REFERENCES `spare` (`sparePartNum`),
ADD CONSTRAINT `orderspare_ibfk_2` FOREIGN KEY (`orderID`) REFERENCES `order` (`orderID`);

--
-- 資料表的限制式 `spareqty`
--
ALTER TABLE `spareqty` ADD CONSTRAINT `spareqty_ibfk_1` FOREIGN KEY (`sparePartNum`) REFERENCES `spare` (`sparePartNum`);

--
-- 資料表的限制式 `user`
--
ALTER TABLE `user` ADD CONSTRAINT `user_ibfk_1` FOREIGN KEY (`salesManagerID`) REFERENCES `salemanager` (`salesManagerID`),
