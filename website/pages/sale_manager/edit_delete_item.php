        ...
        <form name="ED_item" id="ED_item" method="post">
          ...
          <div class="g-10">
            <div class="row">
              <div class="col">
                <div class="form-floating ">
                  <select class="form-select" id="category" name="category" disabled>
                    <option value="A" <?php if ($row["category"] == "A") {
                                        echo "selected";
                                      } ?>>A - Sheet Metal</option>
                    <option value="B" <?php if ($row["category"] == "B") {
                                        echo "selected";
                                      } ?>>B - Major Asssemblies</option>
                    <option value="C" <?php if ($row["category"] == "C") {
                                        echo "selected";
                                      } ?>>C - Light Components</option>
                    <option value="D" <?php if ($row["category"] == "D") {
                                        echo "selected";
              ...
              <div class="col">
                <div class="form-floating">
                  <input type="text" class="form-control" id="name" name="sparePartName" placeholder="Name" value="<?php echo $row["sparePartName"] ?>">
            ...
            <div class="row">
              <div class="col">
                <div class="form-floating">
                  <input type="number" class="form-control" id="qty" name="Quantity" placeholder="Quantity" min="0" value="<?php echo $row["stockItemQty"] ?>">
              ...
              <div class="col">
                <div class="input-group mb-3">
                  ...
                  <div class="form-floating">
                    <input type="number" class="form-control" step="0.01" id="price" name="price" placeholder="Price" min="0" value="<?php echo $row["price"] ?>">
              ...
              <div class="col">
                <div class="input-group mb-3">
                  <div class="form-floating">
                    <input type="number" class="form-control" step="0.0001" id="weight" name="weight" placeholder="Weight" min="0" value="<?php echo $row["weight"] ?>">
            ...
            <div class="row">
              <div class="col">
                ...
                <div class="form-floating">
                  <textarea name="sparePartDescription" class="form-control" placeholder="Description" id="desc" style="height: 7.4rem"><?php echo $row["sparePartDescription"]; ?></textarea>
            ...
            <div class="row">
              <div class="col">
                ...
                <label for="item-img-input" class="form-label">select or drop the image of this spare part (optional)</label>
                <input class="form-control" name="fileToUpload" type="file" id="item-img-input">
