...
if (isset($_POST["sparePartNum"])) {
    if (isset($POST["confirmName"])) {
        ...
        if ((file_exists($_FILES['fileToUpload']['tmp_name']) && is_uploaded_file($_FILES['fileToUpload']['tmp_name']))) {
            ...
            $number = (int) substr($sparePartNumber, 1);
            $FileName = (ord($category) - 64) . str_pad($number + 1, 5, '0', STR_PAD_LEFT) . "." . strtolower(pathinfo($_FILES["fileToUpload"]["name"], PATHINFO_EXTENSION));
