          ...
          <div class="col-md-8 order-md-1">
            ...
            <form class="needs-validation" novalidate="">
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control" id="Delivery-Address" value="Delivery Address" required="" disabled>
              </div>
              <div class="mb-3">
                <label for="address2">Delivery Date of this order<span class="text-muted"></span></label>
                <input type="text" class="form-control" id="Delivery-Date" value="2024-12-24" required="" disabled>
              </div>
              <hr class="mb-4">
              <h4 class="mb-3">Enter your password to delete the order:</h4>
              <div class="mb-3">
                <div class="col-md-12">
                  <label class="labels">Password </label><input type="password" id="Password_delete"
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title" id="exampleModalLabel">Do you confrim?</h5>
