      ...
      <div class="container-fluid justify-content-center">
        ...
        <div class="collapse navbar-collapse nav-wrap" id="navbarSupportedContent">
          ...
          <div class="nav-item dropdown">
            <a class="nav-link dropdown-toggle d-flex flex-nowrap align-items-center" href="#" role="button"
               data-bs-toggle="dropdown" aria-expanded="false">
              Hi [username]<span class="cart-number-label">99+</span>
            </a>
            <ul class="dropdown-menu dropdown-menu-end">
              <li><a class="dropdown-item" href="#">Your Information</a></li>
              <li><a class="dropdown-item" href="#">Your Order</a></li>
              <li>
                <a class="dropdown-item position-relative d-flex flex-nowrap" href="#">Cart<span
                        class="cart-number-label">99+</span></a>
              </li>
            </ul>
          </div>
        </div>
